...
{
    public partial class ListActiveContentRequest : System.Web.UI.Page
    {
        #region Variables
        ...
        protected void rptContentRequest_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if (int.Parse(DataBinder.GetPropertyValue(e.Item.DataItem, "CreatedBy").ToString()) > 0)
                {
                    ...
                    imgBtn.PostBackUrl = "GetContent.aspx?rId=" + DataBinder.GetPropertyValue(e.Item.DataItem, "ContentRequestId").ToString() + "&type=active";
                }
                else
                {
        ...
        {
            string strQuery = "IsEnabled = '1' AND (ContentStatusCode <> 300 OR ContentStatusCode IS NULL)";
